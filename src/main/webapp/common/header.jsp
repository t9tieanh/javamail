    ...
    <nav class="navbar navbar-light bg-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <img id="more-info" src="<c:url value='/template/media/Logo-DH-Su-Pham-Ky-Thuat-TP-Ho-Chi-Minh-HCMUTE-623x800.webp' />" alt="" width="25" height="30" class="d-inline-block align-text-top"></span>
                <div>
                    <div class="name">Pham Tien Anh</div>
                    <div class="subtitle">Student at HCMUTE</div>
                </div>

                <img  src="<c:url value='/template/media/Rocket_ANIM_none.gif' />" style="margin-left: 20px;" alt="" width="40" height="45" class="d-inline-block align-text-top"></span>
            </a>
            ...
            <div class="d-lg-none">
                ...
                <div class="btn-group dropleft position-relative">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                        <li><a class="dropdown-item" href="https://t9tieanh.github.io/tieanh19-infomation"><i class="fas fa-home"></i> Home</a></li>
            ...
            <div class="d-none d-lg-block">
                ...
                <a href="https://t9tieanh.github.io/tieanh19-infomation" style="margin-left: 10px;">
